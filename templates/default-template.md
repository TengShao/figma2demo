...
- Preserve each exported icon's original viewBox, intrinsic size, aspect ratio, fills, strokes, masks, and transforms; do not shrink or stretch a 24px Figma icon into another hand-chosen geometry.
